...
/**
 * A deterministic keyword-based classifier that matches input text against
 * configured keyword patterns to produce confidence scores.
 *
 * Zero external dependencies. Fast and predictable.
 *
 * @example
 * ```typescript
