...
/**
 * Classifies input by comparing its embedding vector against reference vectors
 * using cosine similarity.
 *
 * Requires either a constructor-level `embeddingProvider` or one passed via
 * `context.embeddingProvider` at classify time.
 *
 * @example
 * ```typescript
